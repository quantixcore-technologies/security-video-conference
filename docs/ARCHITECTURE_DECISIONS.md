...
**Обновление 2026-06-05 (Otabek):** ❌ OneID/E-IMZO интеграция (гос-SSO) **исключена из роадмапа** — не планируется. Внутренних учёток + 2FA достаточно; зависимость от гос-IdP не вводим.
