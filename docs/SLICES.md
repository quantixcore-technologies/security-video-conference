...
## 📊 Прогресс: 17 ✅ · 18 ⬜ · 6 🔒 — **17 из ~41** (web/backend-контур)
...
## E4 — Поручения + Задачи (Kanban) ⬜ 0/4 — требования прояснены (D-015)
| # | Слайс | Статус |
|---|-------|--------|
| —   | **E4-A** Tasks backend — поручение/задача (автор→исполнитель, дедлайн, приоритет, статус) + RBAC | ⬜ |
| —   | **E4-B** Kanban-доска UI (колонки по статусам, карточки, drag-drop) | ⬜ |
| —   | **E4-C** Связь с встречами (поручение из совещания) + E3-уведомление исполнителю | ⬜ |
