defmodule Svc.Meetings do
  ...
  # Серии встреч («повтор каждый день/неделю») удалены 2026-09-22 по решению
  # заказчика: в форме создания они только мешали. Колонка `recurrence_group`
  # оставлена — по ней ещё можно найти встречи, созданные до удаления.
